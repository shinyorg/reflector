...
public class TestClassReflector : global::Shiny.Reflector.IReflectorClass
{
    ...
    public global::Shiny.Reflector.PropertyGeneratedInfo[] Properties => new global::Shiny.Reflector.PropertyGeneratedInfo[]
    {
        ...
        new global::Shiny.Reflector.PropertyGeneratedInfo("BirthDate", typeof(global::System.DateTime), true)
    };
    ...
    public object? this[string key]
    {
        get
        {
            switch (key?.ToLower())
            {
                ...
                case "birthdate":
                    return _reflectedObject.BirthDate;
                default:
        ...
        set
        {
            switch (key?.ToLower())
            {
                ...
                case "birthdate":
                    if (value != null && value is not global::System.DateTime)
                        throw new global::System.InvalidOperationException($"Cannot set value for key '{key}' in TestClassReflector. Expected a global::System.DateTime? value.");

                    _reflectedObject.BirthDate = (global::System.DateTime?)value;
                    break;
